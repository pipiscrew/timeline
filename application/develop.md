...
## git
* [git minimal](https://www.nuget.org/packages/Git-Windows-Minimal/) - Git-Bash, Git-Gui, PERL, Python, and Tcl are excluded from Minimal Git. Download rename it to rar, copy the tools folder. Add to environment path the cmd folder. Behind firewall ? whitelist @ git-http-fetch.exe git-http-push.exe git-remote-https.exe exist @ mingw64\bin.
* [Fork](https://fork.dev/)
