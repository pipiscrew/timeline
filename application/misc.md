...
## Rescue Boot
* [Hirens BootCD](https://www.hirensbootcd.org/) - updated FEB 2024 (win11 PE)
...
* [grepWin](https://github.com/stefankueng/grepWin) (search inside files also offers replace)
  * can search for multiple keywords as test|jordan this will match any file contains either test either jordan. if needed escape the backslash '\' as '\\'
...
* backup folder contents with 7zip excluding file extensions & folder names
