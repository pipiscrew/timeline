...
Glycogen reserves are soon used up—just about the time during your run when you notice the exercise is suddenly much harder work. That is why nutritional physiologists say we should do at least an hour’s exercise if we want to burn fat. 
...
The lymphatic system is seen as an under-appreciated weakling everywhere in the body except in the small intestine. This is its time to shine! All the body’s lymph vessels converge in an impressively thick duct, where all the digested fat can gather without the risk of clogging.
