...
In minerals the amount printed of supplements is the whole. Minerals has `elemental form`, approximately is what we know as `bioavailability`. Here is a real world example (daily 3 capsules) :  

| Mineral                | Weight | Elemental |
| ---------------------- | ------ | --------- |
| Magnesium Malate       | 750mg  | 82.5mg    |
| Magnesium Bisglycinate | 750 mg | 150mg     |
| Magnesium Citrate      | 750mg  | 120mg     |

product - [Maxxwin.Magnesium Triple Complex](https://www.maxxwin.cz/maxxwin-magnesium-triple-complex-180-kapsli)

--

### Γλυκινικό Μαγνήσιο (Bisglycinate)
Το γλυκινικό μαγνήσιο θεωρείται από τις κορυφαίες μορφές. Εδώ το μαγνήσιο ενώνεται με τη γλυκίνη, ένα αμινοξύ που έχει φυσική χαλαρωτική δράση.  
Γιατί να το επιλέξετε: Έχει εξαιρετική απορρόφηση, είναι πολύ φιλικό προς το στομάχι (δεν προκαλεί διάρροια) και βοηθάει άμεσα στη χαλάρωση του νευρικού συστήματος.  

* **Bisglycinate** : Είναι η χημικά ακριβής μορφή, όπου το μαγνήσιο δένεται με δύο μόρια γλυκίνης. Αυτή η διπλή σύνδεση εξασφαλίζει τη μέγιστη σταθερότητα και απορρόφηση.
* **Glycinate** : Είναι ο γενικός όρος. Συνήθως αναφέρεται στο ίδιο πράγμα, αλλά για να είστε 100% σίγουροι για την ποιότητα, προτιμήστε ετικέτες που γράφουν ξεκάθαρα Bisglycinate.

### Μηλικό Μαγνήσιο (Malate)
Αν νιώθετε εξαντλημένοι, το μηλικό μαγνήσιο είναι ο σύμμαχός σας. Το μηλικό οξύ παίζει κεντρικό ρόλο στον κύκλο παραγωγής ενέργειας (ATP) στα κύτταρά μας.  
Γιατί να το επιλέξετε: Συχνά προτείνεται σε άτομα με ινομυαλγία ή σύνδρομο χρόνιας κόπωσης. Βοηθάει στην αποκατάσταση των μυών μετά την άσκηση χωρίς να φέρνει υπνηλία.  

### L-Θρεονικό Μαγνήσιο (L-Threonate)
Είναι διάσημο γιατί έχει την ικανότητα να διαπερνά τον `αιματοεγκεφαλικό φραγμό`.  
Γιατί να το επιλέξετε: Στοχεύει απευθείας στον εγκέφαλο, ενισχύοντας τη μνήμη, τη μάθηση και τη συγκέντρωση. Ιδανικό για περιόδους έντονης πνευματικής εργασίας.

### Κιτρικό Μαγνήσιο (Citrate)
Ίσως η πιο δημοφιλής μορφή στην αγορά. Το κιτρικό μαγνήσιο έχει υψηλή βιοδιαθεσιμότητα (περίπου 90%).  
Γιατί να το επιλέξετε: Δρα ως ήπιο φυσικό καθαρτικό, τραβώντας νερό στο έντερο. Είναι η ιδανική και ασφαλής λύση αν υποφέρετε από δυσκοιλιότητα.

### Χηλικό (Chelate)
Είναι η ομπρέλα των καλών μορφών. Σημαίνει ότι το μέταλλο έχει ενωθεί με οργανικά στοιχεία (όπως αμινοξέα) για να το αναγνωρίζει ο οργανισμός σαν τροφή και να το απορροφά τέλεια.  

### Οξείδιο του Μαγνησίου (Magnesium Oxide)
Θα το βρείτε στα περισσότερα φθηνά πολυβιταμινούχα σκευάσματα.  
Προσοχή: Έχει εξαιρετικά χαμηλή απορρόφηση (μόλις 4%). Είναι χρήσιμο μόνο αν θέλετε μια **φθηνή λύση** για έντονη δυσκοιλιότητα ή καούρες, αλλά όχι για να ανεβάσετε τα επίπεδα μαγνησίου σας.  


| Ανάγκη              | Προτεινόμενος Τύπος      | Βασικό Όφελος                          |
| ------------------- | ------------------------ | -------------------------------------- |
| Άγχος & Αϋπνία      | Γλυκινικό (Bisglycinate) | Ηρεμιστική δράση, βελτιώνει τον ύπνο.  |
| Κόπωση & Ινομυαλγία | Μηλικό (Malate)          | Παραγωγή ενέργειας, χωρίς υπνηλία.     |
| Μνήμη & Εγκέφαλος   | L-Θρεονικό (Magtein)     | Το μοναδικό που περνάει στον εγκέφαλο. |
| Δυσκοιλιότητα       | Κιτρικό (Citrate)        | Κινητοποιεί το έντερο φυσικά.          |

Το **Bisglycinate** είναι καλύτερο να λαμβάνεται πριν τον ύπνο για χαλάρωση. Το **Malate** ή το **Citrate** μπορούν να ληφθούν και το πρωί ή κατά τη διάρκεια της ημέρας για `ενέργεια` και `ισορροπία ηλεκτρολυτών`.  

Μπορώ να παίρνω μαγνήσιο κάθε μέρα;
Ναι, το μαγνήσιο είναι **ασφαλές για μακροχρόνια χρήση** στις συνιστώμενες δόσεις. Αν έχετε προβλήματα με τα νεφρά, συμβουλευτείτε οπωσδήποτε τον γιατρό σας.  

[source](https://www.lifetree.gr/blog/news/magnisio-pos-na-epileksete-to-katallilo-gia-esas/)
