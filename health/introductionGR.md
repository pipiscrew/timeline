...
>
> [0.83gr * κιλά](https://www.calculator.net/protein-calculator.html) σώματος, αυτό μας δίνει τα γραμμάρια **πρωτείνης** που **χρειαζόμαστε**. Μετά έχοντας σαν σταθερά ότι **100gr άπαχο κρέας** έχει ~**25gr πρωτείνη** βγάζουμε το [ζητούμενο βάρος](https://pipiscrew.com/apps/fasting/) για το κρέας.  
