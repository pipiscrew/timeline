...
Οι `LSP` πηγαίνουν στο **ήπαρ** και προκαλούν `λιπώδες ήπαρ` και οι μύες γίνονται **ανθεκτικοί στην ινσουλίνη**. Εμφανίζεται `μεταβολικό σύνδρομο`  
* αυξάνεται το **σάκχαρο** στο αίμα
* αυξάνονται τα **τριγλυκερίδια**
* μειώνεται η **HDL**  

Όλοι αυτοί οι **δείκτες** είναι `αθηροσκλήρωσης`. Το `μεταβολικό σύνδρομο` προκαλεί `φλεγμονώδες λίπος`, οι `LPS` πηγαίνοντας στους `υγιείς λιπώδεις ιστούς`, ενεργοποιούν ξανά το `ανοσοποιητικό σύστημα`, γι' αυτό βρίσκουμε `φλεγμονώδη κύτταρα` στο **λίπος** (άτομα με παχυσαρκία: σχεδόν το 50% του λίπους είναι φλεγμονώδη μόρια).  
...
Ομοίως, η [δοκιμή JUPITER](https://en.wikipedia.org/wiki/JUPITER_trial) συνέδεσε την **sdLDL** με καρδιαγγειακούς θανάτους... <u>ακόμη και σε ασθενείς με πολύ χαμηλή</u> LDL-C. &nbsp; [πηγή](https://wholeheartfamilymed.com/advanced-testing/blood-work/lipids/sdldl)  
