...
* 2019 - [Dr. Pradip Jamnadas - Νηστεία για επιβίωση](https://www.youtube.com/watch?v=9ROk0OShVTo&t=1084s)
  * 3 μέρες νηστεία για ισχυρή αντιοξειδωτική δράση
...
3Κατά τη μετάφραση, η αλληλουχία mRNA διαβάζεται σε ομάδες τριών **νουκλεοτιδίων** (είναι τα βασικά δομικά στοιχεία των νουκλεϊκών οξέων) που ονομάζονται κωδικόνια. Κάθε κωδικόνιο αντιστοιχεί σε ένα συγκεκριμένο **αμινοξύ**. Τα μόρια μεταφοράς RNA (tRNA) φέρνουν τα **κατάλληλα αμινοξέα** στο **ριβόσωμα**, όπου το ριβόσωμα διευκολύνει τη **σύνδεση του tRNA στο mRNA**. Το ριβόσωμα κινείται κατά μήκος του mRNA και τα **αμινοξέα συνδέονται** μεταξύ τους (με τη σειρά που **καθορίζεται** από την **αλληλουχία** του **mRNA**), σχηματίζοντας μια πολυπεπτιδική αλυσίδα. Μόλις μεταφραστεί ολόκληρο το mRNA, η πολυπεπτιδική αλυσίδα (γραμμική αλληλουχία αμινοξέων που συνδέονται με πεπτιδικούς δεσμούς) διπλώνεται σε ένα συγκεκριμένο τρισδιάστατο σχήμα για να **γίνει** μια `λειτουργική πρωτεΐνη`.
</div></details></div>  
...
- ναι!
- είναι πολύ ενθαρρυντικό να γνωρίζεις  
...
Γι' αυτό είναι `super super βασικό να έχετε βιταμίνη D`.
