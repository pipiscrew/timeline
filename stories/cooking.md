...
* Στο ταψί1 κάνουμε κομμάτια 40gr 
* Στο ταψί2 βάζουμε κομμάτια 50gr  
...
* Σε 12 λεπτά, αλλάζουμε θέση στα ταψιά, και τα γυρνάμε πίσω μπροστά (180 μοίρες).
* Περιμένουμε άλλα 12 λεπτά. (συνολικός χρόνος 20 - 25 λεπτά)  
