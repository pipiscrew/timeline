...
Τα άτομα της ομάδας Α `δεν μπορούν να χωνέψουν τα περισσότερα από τα γαλακτοκομικά προϊόντα`, για τον απλό λόγο ότι το **αίμα τους δημιουργεί αντισώματα** κατά του κύριου σακχάρου του πλήρους γάλατος, της `D-γαλακτοσαμίνης`. (😜 *GPT says 0.01 to 0.1 grams per liter*)
...
* Εσκαρόλ
* Καρότα
* Κατσαρό λάχανο (λαχανίδα aka `Kale`)
* Κιχώριο
...
AI : 
> Βράστε νερό, ξεφλουδίστε την μπανάνα, σε ένα μπολ ρίχτε το νερό και μετά την **μπανάνα**, αφήστε για 5 λεπτά. **tested & working**.  
...
| `Σύνολο (gr)` :                            | `24.84 (4.69)`       | `88.18 (18.34)`          | `29.47`    | `0.09`  | `11.86`         | `700.79kcal` |
...
* update : optimal είναι **200ml liquid** με **80gr δημητριακών** και άμα χρειάζεται ζάχαρη, 1/2 tsp.  
