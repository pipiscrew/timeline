...
* Δεν είναι μόνο για τα μάτια είναι `θεραπεία` για το κρυολόγημα, τα ιγμόρεια, λίπανση των μυών του λαιμού και της μύτης σας, πολυάριθμων σωματικών πόνων, όπως πονοκεφάλους, ημικρανίες και αυχενική σπονδύλωση, βελτιώνει τη **διάθεσή** σας και σας απαλλάζει από το **άγχος**.
