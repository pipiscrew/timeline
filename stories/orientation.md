...
* Σχετικά με τον `καφέ`, οποιοσδήποτε τύπος καφέ ( γαλλικός / στιγμιαίος / espresso ) έχει κάποια χώρα προέλευσης. Και η `οξύτητα` είναι ανάλογα με την χώρα. Επίσης υπάρχουν και οι τύποι **Arabica / Robusta**. Ο Robusta είναι **πικρός**. Μην πίνετε κάφε από κάψουλες, εντάξει πλάκα είχε τότε όταν βγήκε η Αυστραλέζικη Nespresso. Πλέον επειδή έχει λήξει η πατέντα (μηχανή με κάψουλα), βγάζει ο κάθε πικραμένος κάψουλες για την Nespresso.. Ο καφές με προέλευση από `Βραζιλία`, έχει την **χαμηλότερη οξύτητα**. Οπότε espresso μηχανή με κλείστρο και καφέ [ILLY.Brazil](https://www.ab.gr/el/eshop/p/7723253)... Για **στιγμιαίο** προτιμήστε Jacobs και ποτέ Nescafe...
