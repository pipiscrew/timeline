...
*   Πρέπει να φροντίζετε `B12` / Vitamin D / Μαγνήσιο / Φολικό οξύ να είναι σε επίπεδα από την μέση και πάνω.
    ...
    * [Omega-3](https://mollers.gr/mollers-mourenelaio-gia-tous-enhlikes/) - 1tsp / ημέρα, το υγρό με φυσική γεύση. Σε ένα μεγάλο κουτάλι ρίχνετε μια ποσότητα ίση με 1tsp, το φτάνετε στο λαρύγγι και το χύνετε. Αποθηκεύεται στο ψυγείο.. Το [πνευμονογαστρικό νεύρο](https://www.pipiscrew.com/threads/109145/) εξαρτάται από το `omega-3`. Δεν έχουμε την απαραίτητη ποσότητα έτσι όπως τρεφόμαστε. Με το omega-3 γινέται αύξηση του `πνευμονογαστρικού τόνου`, η οποία είναι η δράση του `παρασυμπαθητικού` νευρικού συστήματος, που είναι υπεύθυνη για τη `χαλάρωση` και την `ανάρρωση`. Το κλειδί είναι η αναλογία omega-3 προς omega-6.
