...
* Σχετικά με τις [επιφάνειες μαγειρέματος](https://pipiscrew.github.io/timeline/#/notes/whenatkitchen?id=frying-pan). Χυτοσίδηρος, γρανίτης (aka θρυμματισμένη πέτρα ή εμπλουτισμένη με ορυκτά), αλουμίνιο ή κεραμική επίστρωση, παρεμπιπτόντως όπου βλέπετε να γράφουν "αντικολλητικό" και δεν εξηγούν τι το κάνει αντικολλητικό είναι [PTFE επίστρωση](https://www.ppg.com/en-US/industrialcoatings/consumer-products/non-stick-and-decorative-kitchenware-coatings) ( πχ 'Skandia Xtreme', [Teflon](https://pipiscrew.github.io/timeline/#/health/teflon) ) αντιδρούν με τα τρόφιμα δηλαδή `μεταφέρονται ουσίες σε αυτά`. Προτιμάτε ατσάλι (aka inox), επίστρωση τιτανίου ή καρβίδιο του πυριτίου και στα ταψιά σμάλτο.
